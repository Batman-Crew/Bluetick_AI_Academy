...
export default function LearningAdvisorForm({ formType, setFormType }) {
  ...
  // -------------------- Render --------------------
  return (
    <div className="px-2 md:px-8 relative my-auto bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 rounded-lg p-4">
      {/* Professional background removed - using gradient instead */}
      {/* <Image
          src={FormBack}
          alt="Form Background"
          width={400}
      ...
      >
        ...
        {!(formType === "hire" || formType === "franchisee") && (
          <div className="mb-5">
            <label htmlFor="learningMode" className="text-[#556376] py-2 font-semibold block">Mode Selection</label>
            <select
              id="learningMode"
              name="learningMode"
            ...
            >
              ...
              <option value="Offline (Indiranagar, besides metro station)">Offline (Indiranagar, Besides Metro Station)</option>
            </select>
            {/* Google Maps Link */}
        ...
        {!(formType === "hire" || formType === "franchisee") && (
          <div className="mb-5">
            <label htmlFor="codingExperience" className="text-[#556376] py-2 font-semibold block">Coding Experience</label>
            <select
              id="codingExperience"
            ...
            >
              ...
              <option value="I have coding experience">I have coding experience</option>
              <option value="I am a beginner (Additional 4 Weekends Python bootcamp)">I am a beginner (Additional 4 Weekends Python bootcamp)</option>
            </select>
